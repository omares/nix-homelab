#
# Having the scripts in the same file as the settings causes the VSCode NixIDE
# formatter to hang, creating a frustrating workflow since files are not saved.
#
{
  lib,
  pkgs,
