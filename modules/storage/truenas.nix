    ...
    lib.mkMerge [
      (lib.mkIf cfgMedia.enable {
        fileSystems."${cfgMedia.mountPoint}" = {
          device = "${mares.nodes.truenas.host}:/mnt/storage01/Media";
          fsType = "nfs";
      ...
      (lib.mkIf cfgBackup.enable {
        fileSystems."${cfgBackup.mountPoint}" = {
          device = "${mares.nodes.truenas.host}:/mnt/storage01/backups/postgres";
          fsType = "nfs";
          options = mountOptions;
        };
      ...
      (lib.mkIf cfgScrytedLarge.enable {
        fileSystems."${cfgScrytedLarge.mountPoint}" = {
          device = "${mares.nodes.truenas.host}:/mnt/storage01/scrypted";
          fsType = "nfs";
          options = mountOptions;
        };
