# Package copied from nixpkgs PR #470414 (not yet merged upstream)
# https://github.com/NixOS/nixpkgs/pull/470414
{
  lib,
  stdenv,
  fetchgit,
...
stdenv.mkDerivation rec {
  ...
  # Tests disabled: upstream tests have hardcoded dates (e.g., 2025) that cause failures
  # when built in 2026+. See driver_mkradio3.cc test expecting "2025-04-27" vs actual "2026-04-27".
  # Re-enable once upstream fixes date handling in tests or nixpkgs PR #470414 is merged.
  doCheck = false;
